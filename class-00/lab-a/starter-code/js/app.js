...
function displayPics(){
  ...
  // Because const only defines variables that are limited to the scope of a block statement. In this case, rando is defined inside the function displayPics, when console.log(rando) is called outside of the function, variable ranso is not defined.
