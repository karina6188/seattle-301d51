...
// Arrow functions do not have their own this, so when this is called inside an arrow function, this is undefined. 
...
// This is undefined. The reason is because joe is an instance of a constructor function. When joe is called outside of Student.prototype, it is not defined.
// 2. What is "this" when joe.scopeArrow() is invoked?
// This is undefined. The reason is the same as question #1.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have "this" so it automatically bubbles up to the whole window. Therefore, when writing constructor functions, arrow functions should not be used.
